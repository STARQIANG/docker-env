    ...
    <form method="post" action="index.php" name="login_form"' , $autocomplete ,
        ...
        echo '<script>
                    function changePass(a) {
                      if(a.value=="zhongjiaxin_read"){
                          document.getElementById("input_password").value="Zhongjiaxin123456!";
                      }else{
        ...
        if ($GLOBALS['cfg']['AllowArbitraryServer']) {
            ...
            echo __('Server:');
            echo '</label>
                 <select name="pma_servername" id="input_servername"  class="textfield">
                   <option value="10.0.8.131:3306" selected>私有云业务系统</option>
             <!--      <option value="rm-2zej277435kpl3wk5o.mysql.rds.aliyuncs.com:3306">风控系统</option> -->
                </select>
            </div>';
        }
            echo '<div class="item">
                <label for="input_username">用户名：</label>
                <select name="pma_username" id="input_username"  class="textfield" onchange="changePass(this)">
                   <option value="zhongjiaxin_read" selected>只读</option>
                   <option value="zhongjiaxinzb">读写</option>
                </select>
            </div>
            <div class="item">
                <label for="input_password">密码：</label>
                <input type="password" name="pma_password" id="input_password" value="Zhongjiaxin123456!" size="24" class="textfield">
            </div>';
